    ...
    <IonPage>
      <IonHeader>
        <IonToolbar style={{ backgroundColor: "blue" }}>
          <IonTitle style={{ color: "Black" }}>Weather App</IonTitle>
          <IonButtons slot="end">
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          <IonToolbar>
            <IonTitle size="large" style={{ fontSize: "2rem" }}>Dashboard</IonTitle>
          </IonToolbar>
        </IonHeader>
        <IonRow className="ion-margin-start ion-margin-end ion-justify-content-center ion-text-center">
          <IonCol size="12">
            <h4 style={{ color: "green" }}>Here's your location-based weather</h4>
          </IonCol>
        </IonRow>
